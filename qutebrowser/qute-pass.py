...
def main(arguments):
    ...
    extractor = tldextract.TLDExtract(extra_suffixes=arguments.extra_url_suffixes.split(','), cache_dir=False)
    extract_result = extractor(arguments.url, cache_dir=False)
